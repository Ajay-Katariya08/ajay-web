...
const trustPoints = [
  ...
  },
  {
    ...
    description: "Optimized Core Web Vitals, fast initial loads, and smooth render cycles.",
  ...
  },
  {
    ...
    description: "Flawless viewports from mobile to 4K displays with WCAG standards.",
          ...
          return (
            ...
            >
              <div className="space-y-3">
                <div className={`w-10 h-10 rounded-xl border flex items-center justify-center ${point.color} group-hover:scale-110 transition-transform duration-300`}>
